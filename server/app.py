...
api.add_resource(RestaurantModel, "/restaurants")
...
api.add_resource(PizzaModel, "/pizzas")


class RestaurantPizzasModel(Resource):
    def post(self):
        try:
...
api.add_resource(RestaurantPizzasModel, "/restaurant_pizzas")
